	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(-7.6287779, 111.5265322),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(-7.6287779, 111.5285322),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
         	labelContent: '<div id="wedding-marker" class="main-icon-wrapper"><div class="big-circle scale-animation"></div><div class="main-icon-text">Lokasi</div></div>',
		...
		'<div class="info-window-wrapper">'+
			'<h6>Pusdikbang SDM Perum Perhutani</h6>'+
			'<div class="info-window-desc">Jl. Rimba Mulya No.11, Kartoharjo, Kota Madiun, Jawa Timur 63117</div>'+
			'<div class="info-window-link"><a href="https://www.google.co.id/maps/dir/Stasiun+Madiun,+Jalan+Kompol+Sunaryo,+Madiun+Lor,+Madiun+City,+East+Java/HR+Pusdikbang+Perhutanioffice,+Jl.+Rimba+Mulya+No.11,+Kartoharjo,+Madiun+City,+East+Java+63117/@-7.623792,111.5241191,16z/data=!3m1!4b1!4m14!4m13!1m5!1m1!1s0x2e79beff48f1ed27:0x9b3eb25e5792851e!2m2!1d111.524247!2d-7.6187852!1m5!1m1!1s0x2e79bef6e8ca2f6f:0x7838241b21ae4a81!2m2!1d111.5287209!2d-7.6287832!3e0?hl=en" class="grey-link with-underline" target="_blank">Lihat Detail Peta</a></div>'+
      	'</div>';
